...
namespace Fatec.Repositories.SharePoint
{
	public class StudentRepository : IStudentRepository
	{
		...
		private static readonly string[] _studentsDefaultViewFields = { "Nome_x0020_Completo", "Curso", "Turno", "Registro_x0020_Geral", "Org_x00e3_o_x0020_Emissor_x0020_", "Data_x0020_de_x0020_Emiss_x00e3_",
				"Data_x0020_de_x0020_Nascimento", "Naturalidade", "Endere_x00e7_o", "Bairro", "Munic_x00ed_pio_x0020_da_x0020_R", "Estado_x0020_de_x0020_Resid_x00e",
				"Telefone_x0020__x0028_res_x0029_", "Celular", "Email", "Turma_x0020_de_x0020_Ingresso", "Data_x0020_da_x0020_Matr_x00ed_c", "Observa_x00e7__x00f5_es_x0020_pa"
		};
		...
		public ICollection<EnrolledDiscipline> GetEnrolledDisciplinesByEnrollment(string enrollment)
		{
			...
			var viewFields = _context.CreateViewFieldsNode("Disciplina", "Matr_x00ed_cula", "Situa_x00e7__x00e3_o", "Hist_x00f3_rico", "Turno", "Nota_x0020_1", "Nota_x0020_2",
				"Faltas_x0020__x0028_1_x00ba__x00", "Faltas_x0020__x0028_2_x00ba__x00", "Faltas", "M_x00e9_dia", "Conceito", "NP", "Author", "Created");

			return _context.ExecuteQuery<EnrolledDiscipline>(LISTS_SERVICE_RELATIVE_PATH, "Disciplinas Matriculadas no Semestre", query, viewFields, StudentMap.MapEnrolledDisciplines);
		}
		...
		public Student GetByEnrollment(string enrollment)
		{
			...
			var viewFields = _context.CreateViewFieldsNode(_studentsDefaultViewFields);

			return _context.ExecuteQuery<Student>(LISTS_SERVICE_RELATIVE_PATH, "Matrículas", query, viewFields, StudentMap.Map, 1).FirstOrDefault();
		}
		...
		public ICollection<Student> GetAll()
		{
			...
			return _context.ExecuteQuery<Student>(LISTS_SERVICE_RELATIVE_PATH, "Matrículas", string.Empty, viewFields, StudentMap.Map);
		}
		...
		public ICollection<StudiesAdvance> GetStudiesAdvanceByEnrollment(string enrollment)
		{
			...
			string viewFields = _context.CreateViewFieldsNode("Semestre", "Disciplina", "Turno", "Situa_x00e7__x00e3_o", "Parecer_x0020_do_x0020_Professor");

			return _context.ExecuteQuery<StudiesAdvance>(LISTS_SERVICE_RELATIVE_PATH, "Aproveitamento de Estudos", query, viewFields, StudentMap.MapStudiesAdvance);
		}
		...
		public ICollection<Exam> GetExamsByEnrollment(string enrollment)
		{
			...
			var viewFields = _context.CreateViewFieldsNode("ID", "Professor", "Disciplina", "Turno", "Data_x0020_P1", "Data_x0020_da_x0020_P2", "Sala_x0020_de_x0020_Aula", "Hor_x00e1_rio_x0028_s_x0029_");

			return _context.ExecuteQuery<Exam>(LISTS_SERVICE_RELATIVE_PATH, "Atribuição de Aulas à Professores", query.ToString(), viewFields, StudentMap.MapExam);
		}

		public ICollection<Requirement> GetRequirementsByEnrollment(string enrollment)
		{
			...
			string viewFields = _context.CreateViewFieldsNode("Category", "V3Comments", "Title", "DueDate", "Resultado", "Author");

			return _context.ExecuteQuery<Requirement>(LISTS_SERVICE_RELATIVE_PATH, "Requerimentos ON-LINE", query, viewFields, StudentMap.MapRequirement);
		}
